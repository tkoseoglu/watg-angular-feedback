...
angular.module('watgRichtextModule.templates', []).run(['$templateCache', function ($templateCache) {
  "use strict";
  $templateCache.put("app/directives/templates/watgRichtextEditorTemplate.html",
    "<div class=btn-group ng-hide=\"config.variables === undefined || config.variables.length === 0 || config.showVariablesSelector===false\"><a class=\"btn btn-default btn-sm dropdown-toggle\" ng-class=\"{'{{config.Button.Style}}':true}\" data-toggle=dropdown ng-disabled=!menuEnabled title=Variables><i class=\"fa fa-book\"></i>&nbsp; <b class=caret></b></a><ul class=dropdown-menu><li ng-repeat=\"v in config.variables\"><a ng-click=\"applyRichText('insertText', v.Name)\">{{v.Name}}</a></li></ul></div><div class=btn-group ng-hide=\"config.fontFamilies === undefined || config.fontFamilies.length === 0 || config.showFontSelector===false\"><a class=\"btn btn-default btn-sm dropdown-toggle\" ng-class=\"{'{{config.Button.Style}}':true}\" data-toggle=dropdown title=\"Font Size\" ng-disabled=!menuEnabled><i class=\"fa fa-font\"></i>&nbsp; <b class=caret></b></a><ul class=dropdown-menu><li ng-repeat=\"f in config.fontFamilies\"><a title={{f.fontName}} ng-click=\"applyRichText('fontName', f.fontName)\"><font ng-style=\"{'font-family': f.fontName}\">{{f.fontName}}</font></a></li></ul></div><div class=btn-group ng-hide=\"config.fontSizes === undefined || config.fontSizes.length === 0 || config.showFontSizeSelector===false\"><a class=\"btn btn-default btn-sm dropdown-toggle\" ng-class=\"{'{{config.Button.Style}}':true}\" data-toggle=dropdown title=Font ng-disabled=!menuEnabled><i class=\"fa fa-text-height\"></i>&nbsp; <b class=caret></b></a><ul class=dropdown-menu><li ng-repeat=\"f in config.fontSizes\"><a ng-click=\"applyRichText('fontSize', f.fontSize)\"><font size={{f.fontSize}}>{{f.fontSizeName}}</font></a></li></ul></div><div class=btn-group ng-hide=\"config.colors === undefined || config.colors.length === 0 || config.showColorSelector===false\"><a class=\"btn btn-default btn-sm dropdown-toggle\" ng-class=\"{'{{config.Button.Style}}':true}\" data-toggle=dropdown title=\"Font Color\" ng-disabled=!menuEnabled><i class=\"fa fa-paint-brush\"></i>&nbsp; <b class=caret></b></a><ul class=dropdown-menu><li ng-repeat=\"c in config.colors\" ng-style=\"{'background-color': '#' + c.colorValue}\"><span title={{c.colorName}} ng-click=\"applyRichText('forecolor', c.colorValue)\" class=pointer><font>{{c.colorName}}</font></span></li></ul></div><div class=btn-group><button ng-disabled=!menuEnabled ng-show=config.showBold type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" title=\"Bold (Ctrl/Cmd+B)\" ng-click=\"applyRichText('bold', null)\"><i class=\"fa fa-bold\"></i></button> <button ng-disabled=!menuEnabled type=button ng-show=config.showItalic class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" title=\"Italic (Ctrl/Cmd+I)\" ng-click=\"applyRichText('italic', null)\"><i class=\"fa fa-italic\"></i></button> <button ng-disabled=!menuEnabled type=button ng-show=config.showStrikeThrough class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" title=Strikethrough ng-click=\"applyRichText('strikethrough', null)\"><i class=\"fa fa-strikethrough\"></i></button> <button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showUnderline title=\"Underline (Ctrl/Cmd+U)\" ng-click=\"applyRichText('underline', null)\"><i class=\"fa fa-underline\"></i></button></div><div class=btn-group><button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showUnorderedList title=\"Bullet list\" ng-click=\"applyRichText('insertunorderedlist', null)\"><i class=\"fa fa-list-ul\"></i></button> <button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showOrderedList title=\"Number list\" ng-click=\"applyRichText('insertorderedlist', null)\"><i class=\"fa fa-list-ol\"></i></button> <button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showReduceIndent title=\"Reduce indent (Shift+Tab)\" ng-click=\"applyRichText('outdent', null)\"><i class=\"fa fa-dedent\"></i></button> <button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showIndent title=\"Indent (Tab)\" ng-click=\"applyRichText('indent', null)\"><i class=\"fa fa-indent\"></i></button></div><div class=btn-group><button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showLeftAlgin title=\"Align Left\" ng-click=\"applyRichText('justifyleft', null)\"><i class=\"fa fa-align-left\"></i></button> <button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showCenterAlign title=Center ng-click=\"applyRichText('justifycenter', null)\"><i class=\"fa fa-align-center\"></i></button> <button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showRightAlign title=\"Align Right\" ng-click=\"applyRichText('justifyright', null)\"><i class=\"fa fa-align-right\"></i></button> <button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showJustify title=Justify ng-click=\"applyRichText('justifyfull', null)\"><i class=\"fa fa-align-justify\"></i></button></div><div class=btn-group><button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showUndo title=Undo ng-click=\"applyRichText('undo', null)\"><i class=\"fa fa-undo\"></i></button> <button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showRedo title=Redo ng-click=\"applyRichText('redo', null)\"><i class=\"fa fa-repeat\"></i></button></div><div class=btn-group><button ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" title=\"Insert hyperlink\" ng-show=config.showInsertLink data-toggle=modal data-target=#{{hyperlinkModalId}}><i class=\"fa fa-link\"></i></button> <button ng-disabled=!menuEnabled class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" title=\"Remove Hyperlink\" ng-show=config.showRemoveLink ng-click=\"applyRichText('unlink', null)\"><i class=\"fa fa-cut\"></i></button></div><div class=btn-group><button ng-click=\"showSourceEditor = !showSourceEditor\" ng-disabled=!menuEnabled type=button class=\"btn btn-default btn-sm\" ng-class=\"{'{{config.Button.Style}}':true}\" ng-show=config.showSourceCode title=\"Edit source\"><i class=\"fa fa-code\"></i></button></div><div><iframe class=watgRichtext ng-hide=showSourceEditor></iframe><textarea id=richTextSource ng-model=richTextSource ng-show=showSourceEditor class=form-control rows=10></textarea></div><div id={{hyperlinkModalId}} class=\"modal fade\"><div class=modal-dialog><div class=modal-content><div class=modal-header><button type=button class=close data-dismiss=modal><span aria-hidden=true>&times;</span> <span class=sr-only>Close</span></button><h4 class=modal-title id=myModalLabel>Create Link</h4></div><div class=modal-body><input ng-model=linkUrl class=form-control></div><div class=modal-footer><button type=button class=\"btn btn-primary\" data-dismiss=modal ng-disabled=!linkUrl ng-click=\"applyRichText('createLink', linkUrl)\">Apply</button> <button type=button class=\"btn btn-primary\" data-dismiss=modal>Cancel</button></div></div></div></div>");
}]);
...
angular.module('watgFileupload.templates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("app/directives/templates/watgFileuploadTemplate.html",
    "<div>{{config.Title}}&nbsp;<span>({{config.AllowedFileExtensions}} extensions only)</span></div><span class=\"btn btn-default btn-file\" ng-class=\"{'{{config.Button.Style}}':true}\"><i class=\"fa fa-plus\" ng-hide=config.IsBusy></i> <i class=\"fa fa-refresh fa-spin\" ng-show=config.IsBusy></i> Browse... <input type=file id=file name=file multiple></span><br><br><div class=\"alert alert-danger\" ng-show=\"fileSelectMessages.length > 0\"><div ng-repeat=\"m in fileSelectMessages\">{{m}}</div></div><div ng-show=\"config.Files.length > 0\"><label>New {{config.Title}} ({{config.Files.length}})</label><div ng-repeat=\"f in config.Files\" class=row><div class=col-sm-5><div class=input-group style=\"margin-bottom: 2px\"><input name=fileName class=\"form-control input-sm\" ng-model=f.name ng-disabled=\"true\"> <span class=input-group-btn><button type=button class=\"btn btn-danger btn-sm\" title=remove ng-click=\"config.Files.splice($index, 1)\"><i class=\"fa fa-remove\"></i></button></span></div></div></div></div><div class=\"alert alert-danger\" ng-show=\"messages.length > 0\"><div ng-repeat=\"m in messages\">{{m}}</div></div>");
}]);
